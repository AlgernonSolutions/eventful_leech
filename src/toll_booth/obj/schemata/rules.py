...
class TargetSpecifier(AlgObject):
    ...
    """
    def __init__(self, specifier_name: str, specifier_type: str):
        """
...
class SharedPropertySpecifier(TargetSpecifier):
    ...
    """
    def __init__(self, specifier_name: str, shared_properties: [str]):
        """
    ...
    def generate_specifiers(self, source_vertex: str, target_constants: [str], **kwargs):
...
class ExtractionSpecifier(TargetSpecifier):
    ...
    """
    def __init__(self, specifier_name: str, extracted_properties: [str]):
        """
    ...
    def generate_specifiers(self, target_constants, extracted_data, **kwargs):
        specifiers = []
        extracted_data = extracted_data[self._specifier_name]
...
class FunctionSpecifier(TargetSpecifier):
    ...
    """
    def __init__(self, specifier_name: str, function_name: str, extracted_properties: [str]):
        """
...
class VertexLinkRuleEntry(AlgObject):
    ...
    def __init__(self,
                 target_type: str,
                 edge_type: str,
                 target_constants: [str],
                 target_specifiers: [TargetSpecifier],
                 if_absent: bool,
                 inbound: bool = False,
                 **kwargs):
        """
...
class VertexLinkRuleSet(AlgObject):
    ...
    def __init__(self, vertex_specifiers: [TargetSpecifier], outbound_rules, inbound_rules):
        """
...
class VertexRules(AlgObject):
    ...
    """
    def __init__(self, linking_rules: [VertexLinkRuleSet] = None):
        """
