...
from toll_booth.obj.data_objects.identifiers import InternalId
import boto3
...
class SensitiveData:
    ...
    def from_insensitive(cls, insensitive_entry, sensitive_table_name=None):
        ...
        for result in results['Items']:
            return result['sensitive_entry']
        raise RuntimeError(f'sensitive value cannot be found: {insensitive_entry}')
